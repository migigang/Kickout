...
public class MonteCarloNode
{
    ...
    public MonteCarloNode(MonteCarloNode parent, int action, BossState state, bool[] allActions)
		{
			this.action = action;
			this.state = state;
		 ...
		 */
		public MonteCarloNode Expand(int action, BossState childState, bool[] allActions)
		{
